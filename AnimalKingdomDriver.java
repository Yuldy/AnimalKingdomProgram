    ...
    public static void main(String[] args) {
        ...
        for(Animal animal : animalList) {
            if(animal instanceof WaterDwellers) {
                numWaterDwellers++;
                WaterDwellers dwellers = (WaterDwellers) animal;
                boolean breathesAir = dwellers.breathesAir();
                if(breathesAir) {
        ...
        for(Animal animal : animalList) {
            if(animal instanceof WaterDwellers) {
                WaterDwellers dwellers = (WaterDwellers) animal;
                String air = dwellers.breathesAir() ? " can breathe air!" : " can breathe water.";
                System.out.println("\t" + animal.getName() + air);
            }
        }
        ...
        for(Animal animal : animalList) {
            if(animal instanceof Endangered) {
                Endangered endangeredAnimals = (Endangered) animal;
                System.out.println(animal.getName() + endangeredAnimals.displayConservationInformation());
            }
        }
